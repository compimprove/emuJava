...
//                    File mutantFile = mutantsDir[ md ];
          ...
          for (int mf = 0; mf < mutantFiles.length; mf++) {
            ...
            StringBuilder oinstrumentedCode = new StringBuilder();
            ...
            if (line.startsWith("//")) {
              ...
              do {
                if (line.contains(mutatedMethod)) {
                  ...
                  ArrayList<String> otempList = new ArrayList<>();
                  ...
                  do {
                    ...
                    if (line.contains("//Mutated with")) {
                      if (conditionCount == 0) {
                        ...
                        StringBuilder instrumentedString = new StringBuilder("try {\n");
                        instrumentedString.append("java.io.File myFile = new java.io.File( traceFile );\n");
                        instrumentedString.append("java.io.RandomAccessFile raf = new java.io.RandomAccessFile( myFile, \"rw\" );\n");
                        instrumentedString.append("raf.skipBytes( ( int )myFile.length() );\n");
                        instrumentedString.append("raf.writeBytes( \"R: 0.0 0 0.0\" );\n");
                        instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                        instrumentedString.append("raf.close();\n");
                        instrumentedString.append("} catch( Exception e ) { }\n");
                        tempList.add(instrumentedString.toString());
                        instrumentedString = new StringBuilder("try {\n");
                        instrumentedString.append("java.io.File myFile = new java.io.File( traceFile );\n");
                        instrumentedString.append("java.io.RandomAccessFile raf = new java.io.RandomAccessFile( myFile, \"rw\" );\n");
                        instrumentedString.append("raf.skipBytes( ( int )myFile.length() );\n");
                        String oinstrumentedString = "try {\n";
                        ...
                        oinstrumentedString += "raf.skipBytes( ( int )myFile.length() );\n";
                        if (line.contains("Mutated with ABS")) {
                          instrumentedString.append("raf.writeBytes( \"N: \" + ").append(getIdentifier(line)).append(");\n");
                          instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                          instrumentedString.append("raf.close();\n");
                          instrumentedString.append("} catch( Exception e ) { }\n");
                          tempList.add(line);
                          ...
                          instrumentedString.append("raf.writeBytes( \"N: true\" );\n");
                          instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                          instrumentedString.append("raf.close();\n");
                          instrumentedString.append("} catch( Exception e ) { }\n");
                          tempList.add(line);
                          ...
                          instrumentedString.append("raf.writeBytes( \"N: \" + ").append(getObject(line)).append(".toString() );\n");
                          instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                          instrumentedString.append("raf.close();\n");
                          instrumentedString.append("} catch( Exception e ) { }\n");
                          tempList.add(line);
                        ...
                        while (conditionCount > 0) {
                          ...
                          if (line.contains("if(") || line.contains("while(")) {
                            ...
                            if (line.contains("if(")) {
                              ...
                              instrumentedString.append("raf.writeBytes( \"").append(innerCondSuffString).append("\" );\n");
                              instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                              instrumentedString.append("raf.close();\n");
                              instrumentedString.append("} catch( Exception e ) { }\n");
                            ...
                            instrumentedString.append("java.io.RandomAccessFile raf = new java.io.RandomAccessFile( myFile, \"rw\" );\n");
                            instrumentedString.append("raf.skipBytes( ( int )myFile.length() );\n");
                            instrumentedString.append("float state_fitness = 0.0f;\n");
                            instrumentedString.append("float local_fitness = 0.0f;\n");
                            instrumentedString.append("float fitness = 0.0f;\n");
                            instrumentedString.append("int state_count = 0;\n");
                            instrumentedString.append("int local_count = 0;\n");
                            oinstrumentedString = "try {\n";
                            oinstrumentedString += "java.io.File myFile = new java.io.File( traceFile );\n";
                            oinstrumentedString += "java.io.RandomAccessFile raf = new java.io.RandomAccessFile( myFile, \"rw\" );\n";
                            oinstrumentedString += "raf.skipBytes( ( int )myFile.length() );\n";
                            if (condition.contains("this")) {
                              ...
                              instrumentedString.append("int stringWeight1 = 0;\n");
                              instrumentedString.append("int stringWeight2 = 0;\n");
                              instrumentedString.append("String _string1 = ").append(predComps[0]).append(".toString();\n");
                              instrumentedString.append("String _string2 = ").append(predComps[1]).append(".toString();\n");
                              instrumentedString.append("for( int _s1=0; _s1<_string1.length(); _s1++ ) {\n");
                              instrumentedString.append("stringWeight1 += _string1.charAt( _s1 );\n");
                              instrumentedString.append("}\n");
                              instrumentedString.append("for( int _s2=0; _s2<_string2.length(); _s2++ ) {\n");
                              instrumentedString.append("stringWeight2 += _string2.charAt( _s2 );\n");
                              instrumentedString.append("}\n");
                              instrumentedString.append("state_fitness = ( float)( stringWeight1 - stringWeight2 ) / ( stringWeight1 + stringWeight2 );\n");
                              instrumentedString.append("state_fitness = Math.abs( state_fitness );\n");
                            } else {
                              ...
                              int localCounter = 0;
                                for (Object o : predicateList) {
                                    ...
                                    instrumentedString.append("if( !(").append(predicate).append(") ) { \n");

                                    switch (operator) {
                                        case "<=":
                                            instrumentedString.append("fitness = ( float )( ").append(operand1).append(" - ").append(operand2).append(" ) / ( float )( ").append(operand1).append(" + ").append(operand2).append("); \n");
                                            instrumentedString.append("fitness = Math.abs( fitness );\n");
                                            break;
                                        case "<":
                                            instrumentedString.append("fitness = ( float )( (").append(operand1).append("+1) - ").append(operand2).append(" ) / ( float )( (").append(operand1).append("+1) + ").append(operand2).append("); \n");
                                            instrumentedString.append("fitness = Math.abs( fitness );\n");
                                            break;
                                        case ">=":
                                            instrumentedString.append("fitness = ( float )( ").append(operand2).append(" - ").append(operand1).append(" ) / ( float )( ").append(operand2).append(" + ").append(operand1).append("); \n");
                                            instrumentedString.append("fitness = Math.abs( fitness );\n");
                                            break;
                                        case ">":
                                            instrumentedString.append("fitness = ( float )( (").append(operand2).append("+1) - ").append(operand1).append(" ) / ( float )( (").append(operand2).append("+1) + ").append(operand1).append("); \n");
                                            instrumentedString.append("fitness = Math.abs( fitness );\n");
                                            break;
                                        case "==":
                                            instrumentedString.append("fitness = ( float )( ").append(operand2).append(" - ").append(operand1).append(" ) / ( float )( ").append(operand2).append(" + ").append(operand1).append("); \n");
                                            ...
                                            break;
                                        case "!=":
                                            instrumentedString.append("fitness = 0.5f;\n");
                                            break;
                                    }
                                    if (isStateVariable(operand1, cComponents)) {
                                        instrumentedString.append("state_fitness += fitness;\n");
                                        instrumentedString.append("state_count++;\n");
                                        stateCounter++;
                                    } else {
                                        instrumentedString.append("local_fitness += fitness;\n");
                                        instrumentedString.append("local_count++;\n");
                                        localCounter++;
                                    } //END if-else STATEMENT
                                    instrumentedString.append("}\n");
                                } //END for LOOP
                              if (stateCounter > 1) {
                                instrumentedString.append("if( state_count>1 ) {\n");
                                instrumentedString.append("state_fitness *= 0.5f;\n");
                                instrumentedString.append("}\n");
                              } //END if STATEMENT
                              if (localCounter > 1) {
                                instrumentedString.append("if( local_count>1 ) {\n");
                                instrumentedString.append("local_fitness *= 0.5f;\n");
                                instrumentedString.append("}\n");
                              } //END if STATEMENT
                            } //END if-else STATEMENT

                            instrumentedString.append("raf.writeBytes( \"R: \" + state_fitness + \" ").append(approach_level).append(" \" + local_fitness );\n");
                            instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                            if (ifWhileMutation) {
                              instrumentedString.append("raf.writeBytes( \"N: false\" );\n");
                              instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                              oinstrumentedString += "raf.writeBytes( \"N: false\" );\n";
                              oinstrumentedString += "raf.writeBytes( \"\\n\" );\n";
                            } else {
                              instrumentedString.append("raf.writeBytes( \"N: c\" );\n");
                              instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                              instrumentedString.append("raf.writeBytes( \"S: c Normal\" );\n");
                            } //END if-else STATEMENT
                            instrumentedString.append("raf.writeBytes( \"\\n\" );\n");
                            instrumentedString.append("raf.close();\n");
                            instrumentedString.append("} catch( Exception e ) { }\n");
                      ...
                      if (conditionCount == 0 || conditionCount == 1) {
                        ...
                        otempList.add(oline);
                          for (String s : tempList) {
                              String tempLine = (String) s;
                              instrumentedCode.append(tempLine);
                              instrumentedCode.append("\n");
                          } //END for LOOP
                        tempList.clear();
                          for (String s : otempList) {
                              String otempLine = (String) s;
                              oinstrumentedCode.append(otempLine);
                              oinstrumentedCode.append("\n");
                          } //END for LOOP
                        otempList.clear();
                      } else {
                        tempList.add(line);
                      ...
                      if (conditionCount == 0) {
                        instrumentedCode.append(line);
                        instrumentedCode.append("\n");
                        oinstrumentedCode.append(oline);
                        oinstrumentedCode.append("\n");
                  ...
                  if (isMutatedMethod && line.contains("if(")) {
                    ...
                    oinstrumentedString += "raf.close();\n";
                    oinstrumentedString += "} catch( Exception e ) { }\n";
                    instrumentedCode.append(instrumentedString);
                    oinstrumentedCode.append(oinstrumentedString);
                    controlCount++;
                    methodEndCount++;
              ...
              raf.writeBytes(instrumentedCode.toString());
              raf.close();
              oraf.writeBytes(oinstrumentedCode.toString());
              oraf.close();
            } else {
              oline = olnr.readLine();
              do {
