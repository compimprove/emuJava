 ...
 * 
 */
public class ClassicGeneticAlgorithm extends Thread {
    ...
    private int traceCount, iterationNumber;
    ...
    public void run() {
        this.executeClassicGA();
        GAManager.RUNNING_THREADS--;
    } //END run() METHOD
    
    public void executeClassicGA() {
    ...
    public void executeTestCases( Target target ) {
        try {
            ...
            for( int t=0; t<this.population.size() ; ) {
                for( int a=1; a<=5 && t<this.population.size(); a++,t++ ) {
    ...
    public void evaluateTestCases( Target target ) {
        ...
        try {
            FOR: for( int t=0; t<this.population.size(); t++ ) {
                TestCase testCase = ( TestCase )this.population.get( t );
                int traceNumber = ( this.iterationNumber * EMConstants.POPULATION_SIZE ) + t + 1;
                File fileI = new File( EMConstants.PROJECT_LOCATION + EMConstants.PROJECT_NAME + "/traces/" + this.threadNumber + "-" + traceNumber + "Itrace.txt" );
                File fileO = new File( EMConstants.PROJECT_LOCATION + EMConstants.PROJECT_NAME + "/traces/" + this.threadNumber + "-" + traceNumber + "Otrace.txt" );
                if( fileI.exists() && fileO.exists() ) {
                    ...
                    if( lineI!=null ) {
                        ...
                        if( lineI==null ) {
                                ...
                                if( isSufficient ) {
                                    ...
                                    if( listI.size()>0 && listO.size()>0 ) {
                                        ...
                                        if( suffI.equals( suffO ) ) {
                                            ...
                                            EMuJava.jTextArea2.append( "\nFITNESS: [(" + testCase.getApproachLevel() + ", " + testCase.getLocalFitness() + ") ; " + testCase.getNecessityCost() + " ; " + testCase.getSufficiencyCost() + "]" );
                                    ...
                                    testCase.setWeight( testCase.getWeight()-( testCase.getApproachLevel()+testCase.getLocalFitness() ) );
                                    EMuJava.jTextArea2.append( "\nFITNESS: [(" + testCase.getApproachLevel() + ", " + testCase.getLocalFitness() + ") ; " + testCase.getNecessityCost() + " ; c]" );
                                    EMuJava.jTextArea2.append( "\nWEIGHT: " + testCase.getWeight() + "\n\n" );
                                } //END if-else STATEMENT
                            } else {
                                EMuJava.jTextArea2.append( "\nFITNESS: Cannot be Calculated!" );
                            ...
                            if( token.equals( "0" ) ) {
                                testCase.setWeight( testCase.getWeight()+1 );
                            } //END if STATEMENT
                            ...
                            testCase.setSufficiencyCost( "c" );
                            testCase.setWeight( testCase.getWeight()-( testCase.getApproachLevel()+testCase.getLocalFitness() ) );
                            EMuJava.jTextArea2.append( "\nFITNESS: [(" + testCase.getApproachLevel() + ", " + testCase.getLocalFitness() + ") ; c ; c]" );
                            EMuJava.jTextArea2.append( "\nWEIGHT: " + testCase.getWeight() + "\n\n" );
                        } //END if-else STATEMENT
                    } else {
                        EMuJava.jTextArea2.append( "Test Case# " + (t+1) + "\n" );
    ...
    public void performTournamentSelection() {
        ...
        while( selectedPopulation.size() < EMConstants.POPULATION_SIZE ) {
            tournamentPopulation.clear();
            int ts_k = 1;
            //Pick k number of Chromosomes from Population
            while( ts_k <= ClassicGeneticAlgorithm.TS_K ) {
            ...
            selectedPopulation.add( bestCase );
        } //END while LOOP
    ...
    public void crossoverPopulation() {
        ...
        selectedPopulation.clear();
    } //EDN crossoverPopulation() METHOD
...
} //END ClassicGenericAlgorithm CLASS
